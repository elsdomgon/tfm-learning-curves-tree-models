...
# Guarda dos CSVs:
#   - resultados_detalle_random.csv   → una fila por (T, E, fold, task_id)
#   - resultados_agregados_random.csv → una fila por (T, E), medias sobre los 20 datasets
# =============================================================================
...
df_detalle.to_csv('resultados_detalle_random.csv', index=False)
print("\nGuardado: resultados_detalle_random.csv")
...
df_agregado.to_csv('resultados_agregados_random.csv', index=False)
print("Guardado: resultados_agregados_random.csv")
